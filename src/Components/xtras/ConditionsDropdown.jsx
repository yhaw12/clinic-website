    ...
    <div className="bg-[#3D2C57] text-white w-full max-w-[1440px] mx-auto px-[4.5rem] py-10">
      <div className="flex gap-x-12">
        ...
        <div className="relative flex-shrink-0">
          ...
          {[
            { top: "8%", left: "50%" },   // head
            { top: "18%", left: "70%" },  // shoulder
            { top: "30%", left: "40%" },  // elbow
            { top: "40%", left: "60%" },  // hip
            { top: "55%", left: "30%" },  // hand/wrist
            { top: "65%", left: "50%" },  // knee
            { top: "85%", left: "50%" },  // ankle
          ].map(({ top, left }, i) => (
            <button
              key={i}
        ...
        <div className="flex-1 space-y-6">
          <h3 className="text-3xl font-light">Tell us where it hurts</h3>
          <div className="space-y-4 text-base leading-relaxed max-w-xl">
            <p>
              Let’s start getting you back to your very best.
            </p>
            <p>
              Whatever your orthopaedic condition or sports injury, we have a team of top medical experts waiting to help.
            </p>
            <p>
              Our specialisms cover knee, foot & ankle, spine, shoulder, elbow, hand & wrist, head injuries, hip & groin, chest & ribs, podiatry and pain conditions.
            </p>
          </div>
        </div>
