...
import paymentImage from "../../../assests/image1.jpeg"; // replace with an actual image
import billingSupportImage from "../../../assests/mri.jpg"; // replace with an actual image
      ...
      <main className="flex-grow">
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-16 mb-16 flex flex-col md:grid md:grid-cols-2 items-stretch">
          ...
          <div className="bg-purple-700 text-white p-8 flex flex-col justify-between mt-8 relative order-1 md:order-2">
            ...
            <p className="mb-4">We ensure transparency and support throughout the billing process.</p>
